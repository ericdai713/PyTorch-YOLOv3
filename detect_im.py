...
if __name__ == "__main__":
    ...
    #weights_path = '/content/gdrive/My Drive/yolov3/yolov3_ckpt_52.pth'
    ...
    n_cpu = 0
    img_size = 416
    checkpoint_model = '/content/gdrive/My Drive/yolov3/yolov3_ckpt_52.pth'
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        plt.close()
        '''
    with open('/content/gdrive/My Drive/yolov3/0856612.json', 'w') as outfile:
